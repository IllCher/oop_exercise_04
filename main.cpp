...
int main() {
    ...
    while (std::cin >> command) {
        if (command == "tri") {
            ...
            std::tuple<vertex, vertex, vertex, vertex, vertex, vertex, vertex, vertex> tOctagon(make_pair(A.first, A.second), make_pair(B.first, B.second), make_pair(C.first, C.second), make_pair(D.first, D.second), make_pair(E.first, E.second), make_pair(F.first, F.second), make_pair(G.first, G.second), make_pair(H.first, H.second));
            TOctagon<int> octagon(A.first, A.second, B.first, B.second, C.first, C.second, D.first, D.second, E.first, E.second, F.first, F.second, G.first, G.second, H.first, H.second);
