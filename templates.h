...
template <class T>
typename std::enable_if<IsTTriangle<T>::value, typename T::type>::type
area(const T& t) {
    return absolute(((t.A.first - t.C.first) * (t.B.second - t.C.second) - (t.B.first - t.C.first) * (t.A.second - t.C.second)) / 2);
}
...
template <class T>
typename std::enable_if<IsTSquare<T>::value, typename T::type>::type
area(const T& s) {
    return static_cast<typename T::type>(((s.C.first - s.A.first) * (s.C.first - s.A.first) + (s.C.second - s.A.second) * (s.C.second - s.A.second))/2);
}
...
T area(const std::tuple<std::pair<T, T>, std::pair<T, T>, std::pair<T, T>, std::pair<T, T>, std::pair<T, T>, std::pair<T, T>, std::pair<T, T>, std::pair<T, T>>& tOctagon) {
    return absolute(((std::get<0>(tOctagon).first * std::get<1>(tOctagon).second) + (std::get<1>(tOctagon).first * std::get<2>(tOctagon).second) + (std::get<2>(tOctagon).first * std::get<3>(tOctagon).second) + (std::get<3>(tOctagon).first * std::get<4>(tOctagon).second) + (std::get<4>(tOctagon).first * std::get<5>(tOctagon).second) + (std::get<5>(tOctagon).first * std::get<6>(tOctagon).second) + (std::get<6>(tOctagon).first * std::get<7>(tOctagon).second) + (std::get<7>(tOctagon).first * std::get<0>(tOctagon).second) - (std::get<1>(tOctagon).first * std::get<0>(tOctagon).second) - (std::get<2>(tOctagon).first * std::get<1>(tOctagon).second) - (std::get<3>(tOctagon).first * std::get<2>(tOctagon).second) - (std::get<4>(tOctagon).first * std::get<2>(tOctagon).second) - (std::get<5>(tOctagon).first * std::get<4>(tOctagon).second) - (std::get<6>(tOctagon).first * std::get<5>(tOctagon).second) - (std::get<7>(tOctagon).first * std::get<6>(tOctagon).second) - (std::get<0>(tOctagon).first * std::get<7>(tOctagon).second)) / 2);
}

template <class T>
T area(const std::tuple<std::pair<T, T>, std::pair<T, T>>& tSquare) {
    return (((std::get<1>(tSquare).first - std::get<0>(tSquare).first) * (std::get<1>(tSquare).first - std::get<0>(tSquare).first) + (std::get<1>(tSquare).second - std::get<0>(tSquare).second) * (std::get<1>(tSquare).second - std::get<0>(tSquare).second))/2);
}
#endif //TEMPLATES_H_